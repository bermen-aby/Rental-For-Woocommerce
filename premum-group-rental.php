...
add_filter('woocommerce_product_get_price', 'convert_rental_price_based_on_currency', 10, 2);
add_filter('woocommerce_product_get_regular_price', 'convert_rental_price_based_on_currency', 10, 2);

function convert_rental_price_based_on_currency($price, $product)
{
// Vérifier si le produit est un produit de location
if ($product->get_type() == 'rental') {
$currency = get_woocommerce_currency();
// Adapter la conversion en fonction de la devise
switch ($currency) {
case 'USD':
$price = $price * 1.11; // Exemple : conversion en USD
break;
case 'EUR':
$price = $price * 1; // Exemple : conversion en EUR
break;
case 'XAF':
$price = $price * 656.08; // Exemple : conversion en CFA
break;
